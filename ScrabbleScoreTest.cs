...
//     {
//         Assert.Equal(9, scrabble_score.ScrabbleScore.SpecialLetterScore(scrabble_score.ScrabbleScore.Score(word), word, "double", new List<char>{'n'}));
//     }
    
//     [Fact]
//     public void Triple_letter()
//     {
//         Assert.Equal(10, scrabble_score.ScrabbleScore.SpecialLetterScore(scrabble_score.ScrabbleScore.Score(word), word, "Triple", new List<char>{'n'}));
//     }

//     [Fact]
//     public void Double_word()
//     {
//         Assert.Equal(16, scrabble_score.ScrabbleScore.SpecialWordScore(scrabble_score.ScrabbleScore.Score(word), "Double"));
//     }

//     [Fact]
//     public void Triple_word()
//     {
//         Assert.Equal(24, scrabble_score.ScrabbleScore.SpecialWordScore(scrabble_score.ScrabbleScore.Score(word), "triple"));
//     }

//     [Fact]
//     public void Special_word_and_letter()
//     {
//         Assert.Equal(30, scrabble_score.ScrabbleScore.SpecialWordScore(scrabble_score.ScrabbleScore.SpecialLetterScore(scrabble_score.ScrabbleScore.Score(word), word, "double", new List<char>{'n', 't'}), "triple"));
//     }
...
//     {
//         Assert.Equal(8, scrabble_score.ScrabbleScore.SpecialWordScore(scrabble_score.ScrabbleScore.Score(word), "Doubleword"));
//     }
